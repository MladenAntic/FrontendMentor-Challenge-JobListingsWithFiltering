...
http.onload = function () {
         ...
         <div class="company">
           ...
           <div class="company-info">
             <div class="company-name-wrapper">
               ...
               <span class="new-tag">${item.new}</span>
               <span class="featured-tag">${item.featured}</span>
             </div>
  ...
  const newTag = mainContainer.querySelectorAll(".new-tag");
  const featuredTag = mainContainer.querySelectorAll(".featured-tag");
  const tags = mainContainer.querySelectorAll(".tag");

  newTag.forEach(newt => {
    if (newt.innerText === 'TRUE') {
      newt.innerText = 'New'
    } else {
  ...
  featuredTag.forEach(featuredt => {
    if (featuredt.innerText === 'TRUE') {
      featuredt.innerText = 'Featured'
    } else {
      featuredt.style.display = 'none'
    }
  })
